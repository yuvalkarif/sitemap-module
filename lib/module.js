...
module.exports = async function module(moduleOptions) {
  ...
  nuxtInstance.extendRoutes((routes) => {
    ...
    globalCache.staticRoutes = getStaticRoutes(routes, moduleOptions.staticRoutesOptions)
    globalCache.staticExcludedRoutes = getExcludedSitemapStaticRoutes(routes, moduleOptions.staticRoutesOptions)
